...
public class JwtProvider {
    ...
    private SecretKey getSigningKey() {
        byte[] encodedKey = Base64.getEncoder().encode(JWT_SECRET.getBytes()); //SecretKey 통해 서명 생성
        return Keys.hmacShaKeyFor(encodedKey);   //일반적으로 HMAC (Hash-based Message Authentication Code) 알고리즘 사용
    }
